...
var Popup = function (_Overlay) {
    ...
    function Popup(opt_options) {
        ...
        _this.btn.style.background = "grey";
        ...
        /*_this.btn.addEventListener('click', function () {
          ...
          document.getElementById('clear_btn').setAttribute('class','flex items-center mr-8  text-black rounded-lg  bg-green-500 hover:bg-blue-500  group');
          document.getElementById('query_panel_btn').setAttribute('class','flex items-center mr-8 text-black rounded-lg  bg-green-500 hover:bg-blue-500  group');
          document.getElementById('info_btn').setAttribute('class','flex items-center mr-8  text-black rounded-lg  bg-green-500 hover:bg-blue-500  group');
          document.getElementById('wms_layers_btn').setAttribute('class','flex items-center  text-black rounded-lg  bg-green-500 hover:bg-blue-500  group');
        ...
        _this.btn2.style.background = "#006fb3";
        _this.btn2.style.left = "50%";
